---
tags:
  - AntelopeIO/leap/tree/v3.2.0-rc1/docs/02_cleos/02_how-to-guides/how-to-get-block-information.md
  - AntelopeIO/leap
  - v3.2.0-rc1
title: How-To-Get-Block-Information
---
## Goal
...
* Understand what a [block](/docs/latest/glossary#block) is and its role in the blockchain.
* Understand the [block lifecycle](/docs/latest/protocol/consensus_protocol#5-block-lifecycle) in the Antelope consensus protocol.
...
```
Reference to [testnet providers](/docs/latest/resources/)
