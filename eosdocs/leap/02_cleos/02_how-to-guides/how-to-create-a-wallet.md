---
tags:
  - AntelopeIO/leap/tree/v3.2.0-rc1/docs/02_cleos/02_how-to-guides/how-to-create-a-wallet.md
  - AntelopeIO/leap
  - v3.2.0-rc1
...
* Understand [Accounts and Permissions](/docs/latest/protocol/accounts_and_permissions) in the protocol documents.
* Understand what a [public](/docs/latest/glossary#public-key) and [private](/docs/latest/glossary#private-key) key pair is.
