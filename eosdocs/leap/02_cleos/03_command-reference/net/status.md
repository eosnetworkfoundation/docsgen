---
tags:
  - AntelopeIO/leap/tree/v3.2.0-rc1/docs/02_cleos/03_command-reference/net/status.md
  - AntelopeIO/leap
  - v3.2.0-rc1
title: Status
---
...
**Note:** The `last_handshake` field contains the chain state of the specified peer as of the last handshake message with the node. For more information read the [Handshake Message](/docs/latest/protocol/network_peer_protocol#421-handshake-message) in the *Network Peer Protocol* document.
