---
tags:
  - AntelopeIO/leap/tree/v3.2.0-rc1/docs/02_cleos/03_command-reference/net/peers.md
  - AntelopeIO/leap
  - v3.2.0-rc1
title: Peers
---
...
**Note:** The `last_handshake` field contains the chain state of each connected peer as of the last handshake message with the node. For more information read the [Handshake Message](/docs/latest/protocol/network_peer_protocol#421-handshake-message) in the *Network Peer Protocol* document.
