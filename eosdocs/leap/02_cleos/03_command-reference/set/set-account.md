---
tags:
  - AntelopeIO/leap/tree/v3.2.0-rc1/docs/02_cleos/03_command-reference/set/set-account.md
  - AntelopeIO/leap
  - v3.2.0-rc1
title: Set-Account
---
...
## See Also
- [Accounts and Permissions](/docs/latest/protocol/accounts_and_permissions) protocol document.
