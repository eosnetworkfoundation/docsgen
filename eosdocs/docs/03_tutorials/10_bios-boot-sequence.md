---
tags:
  - eosnetworkfoundation/docs/tree/main/docs/03_tutorials/10_bios-boot-sequence.md
...
For instructions on creating a wallet and importing the keys, see the [Create development wallet](/leap/latest/cleos/how-to-guides/how-to-create-a-wallet) tutorial.
...
For commands on creating new accounts, see the [`Create test accounts`](/leap/latest/cleos/how-to-guides/how-to-create-an-account) tutorial.
