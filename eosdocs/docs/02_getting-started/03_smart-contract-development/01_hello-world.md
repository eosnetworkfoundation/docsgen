---
tags:
  - eosnetworkfoundation/docs/tree/main/docs/02_getting-started/03_smart-contract-development/01_hello-world.md
...
Create an account for the contract using [cleos create account](http://docs.eosnetwork.com/leap/latest/cleos/command-reference/create/account), with the command provided below.

```shell
cleos create account eosio hello YOUR_PUBLIC_KEY -p eosio@active
```

Deploy the compiled `wasm` to the blockchain with [cleos set contract](http://docs.eosnetwork.com/leap/latest/cleos/command-reference/set/set-contract).
